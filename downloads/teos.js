...
const IDENTITY_URL = process.env.TEOS_IDENTITY_URL || 'https://activation-service-production-4228.up.railway.app';
...
function cmdVersion() {
  ...
  console.log(`Rules:   111 (64 core + 29 Solana + 10 EVM + 8 banking)`);
  console.log(`Tests:   471`);
